...
MODEL_STRUCTURE = {
    'DiT_XL': {'depth':28, 'n_emb':1152, 'num_heads':16,},
    'DiT_L': {'depth': 24, 'n_emb': 1024, 'num_heads': 16, },
    'DiT_B': {'depth': 12, 'n_emb': 768, 'num_heads': 12, },
...
class DitDiffusionPolicyConfig(PretrainedConfig):
    ...
    def __init__(
            ...
            cond_dim: int = 2048,  # the input dim of the condition
