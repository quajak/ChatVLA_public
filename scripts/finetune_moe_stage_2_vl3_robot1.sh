...
OUTPUT=/home/jovyan/tzb/zhouzy/model_param/qwen2_vla_param_${ACTION_HEAD}_results/ckpts/${TASK}/${LLM}_${LLM_MODEL_SIZE}/Qwen2_${LLM_MODEL_SIZE}_v0_w_llava_finetune_moe_2parts_w_lora_step_2_cosine_2e_5_s1_8k_ro3_vl1
...
PRETRAIN=/home/jovyan/tzb/zhouzy/model_param/qwen2_vla_param_${ACTION_HEAD}_results/ckpts/${TASK}/${LLM}_${LLM_MODEL_SIZE}/Qwen2_${LLM_MODEL_SIZE}_v0_w_llava_finetune_moe_2parts_w_lora_step_1_constant_1e_4/checkpoint-8000
if [ -d "$OUTPUT" ]; then
   echo 'output exists'
else
