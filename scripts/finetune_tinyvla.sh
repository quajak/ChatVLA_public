#!/bin/bash
TASK=mobile_franka_reasoning_no_vl_data_selected
LLM=qwen2_vl
#LLM_MODEL_SIZE=7B
LLM_MODEL_SIZE=2B
...
OUTPUT=/home/jovyan/tzb/zhouzy/model_param/qwen2_vla_param_${ACTION_HEAD}_results/ckpts/${TASK}/${LLM}_${LLM_MODEL_SIZE}/Qwen2_${LLM_MODEL_SIZE}_tinyvla_lora_unet
