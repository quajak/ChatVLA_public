...
OUTPUT=/home/jovyan/tzb/zhouzy/model_param/qwen2_vla_param_${ACTION_HEAD}_results/ckpts/${TASK}/${LLM}_${LLM_MODEL_SIZE}/0412_Qwen2_lora_no_filmlayer_w_reasoningaction_static_2
...
deepspeed --master_port 29604 --num_gpus=8 --num_nodes=1 ./train_vla.py \
  ...
  --vl_ratio 0.33 \
  --using_moe True \
  --using_static_expert True \
  --using_shared_routed_expert False \
  --shared_expert_num 0 \
  --routed_expert_num 0 \
  --lora_module "vitllm" \
