...
OUTPUT=/home/jovyan/tzb/zhouzy/model_param/qwen2_vla_param_${ACTION_HEAD}_results/ckpts/${TASK}/${LLM}_${LLM_MODEL_SIZE}/0414_deepspeed_Qwen2_lora_no_filmlayer_w_reasoningaction_static_2_share1_route2_top_1
