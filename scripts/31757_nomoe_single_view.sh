#!/bin/bash
TASK=0316_franka_math_w_vl_text_math_single_view
LLM=qwen2_vl
#LLM_MODEL_SIZE=7B
LLM_MODEL_SIZE=2B
...
OUTPUT=/home/jovyan/tzb/zhouzy/model_param/qwen2_vla_param_${ACTION_HEAD}_results/ckpts/${TASK}/${LLM}_${LLM_MODEL_SIZE}/${TASK}_Qwen2_${LLM_MODEL_SIZE}_lora_reasoning_as_cond_no_moe_w_filmlayer
