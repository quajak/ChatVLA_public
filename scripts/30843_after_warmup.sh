...
OUTPUT=/home/jovyan/tzb/zhouzy/model_param/qwen2_vla_param_${ACTION_HEAD}_results/ckpts/${TASK}/${LLM}_${LLM_MODEL_SIZE}/0420_after_warmup_freeze_head_Qwen2_lora_no_filmlayer_w_reasoningaction_share1_route4_top_2
...
PRETRAIN=/home/jovyan/tzb/zhouzy/model_param/qwen2_vla_param_${ACTION_HEAD}_results/ckpts/0420_all_robot_warmup/${LLM}_${LLM_MODEL_SIZE}/0420_freeze_head_Qwen2_lora_no_filmlayer_w_reasoningaction_share1_route4_top_2/checkpoint-3027
if [ -d "$OUTPUT" ]; then
   echo 'output exists'
else
