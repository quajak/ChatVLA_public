...
OUTPUT=/home/jovyan/tzb/zhouzy/model_param/qwen2_vla_param_${ACTION_HEAD}_results/ckpts/${TASK}/${LLM}_${LLM_MODEL_SIZE}/0418_cross_attn_Qwen2_lora_no_filmlayer_w_reasoningaction_share1_route4_top_2
...
deepspeed --master_port 29607 --num_gpus=8 --num_nodes=1 ./train_vla.py \
  ...
  --using_groot_like_attn True
#  --output_expert_traffic True
